...
const linkVariants = cva(
  'transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-alfred-primary',
  {
    variants: {
      variant: {
...
export const Link = forwardRef<HTMLAnchorElement, LinkProps>(
  ({ className, variant, size, underline, children, href, external, prefetch, ...props }, ref) => {
