...
export const Footer = () => {
  return (
    <footer className="w-full bg-alfred-primary text-white py-16 md:py-20">
      <Container>
        <div className="flex flex-col space-y-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 md:gap-6">
            ...
            <div className="lg:col-span-2">
              ...
              <Paragraph variant="white" className="opacity-70 mb-6">
                Alfred Holdings is a forward-thinking group of brands that leads the way in connecting consumers to a host of financial and related services.
              </Paragraph>
          ...
          <div className="pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <Paragraph variant="white" size="sm" className="opacity-60 text-center md:text-left">
