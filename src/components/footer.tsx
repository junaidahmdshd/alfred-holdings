...
export const Footer = () => {
  return (
    <footer className="w-full bg-[#132b39] py-20 text-white md:py-20">
      <Container className="px-4 md:px-8">
        {/* Main Content */}
        <div className="mb-20 flex flex-col gap-6 md:flex-row md:gap-16">
          {/* Left Column */}
          <div className="flex flex-col gap-6 md:w-[643px]">
            ...
            <div className="w-full">
              <p className="text-sm leading-[1.5em] font-medium tracking-tight text-[#dfe3e7]">
                Alfred Holdings is a Dubai-based investment group behind InsuranceMarket.ae and
                more. We build trust-driven ventures across the GCC.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 md:flex-grow">
            ...
            <div className="flex flex-wrap justify-between gap-4 md:flex-nowrap">
              <Link href="/about-us" className="py-2 text-sm font-semibold text-[#eef7fc]">
                About Us
              </Link>
              <Link href="/companies" className="py-2 text-sm font-semibold text-[#eef7fc]">
                Companies
              </Link>
              <Link href="/careers" className="py-2 text-sm font-semibold text-[#eef7fc]">
                Careers
              </Link>
              <Link href="/contact-us" className="py-2 text-sm font-semibold text-[#eef7fc]">
                Contact Us
              </Link>
            </div>
            ...
            <div className="flex gap-6">
              ...
              <Link href="#" aria-label="Instagram">
                ...
                >
                  ...
                  />
                  <path
                    d="M13.2312 3.72792C13.2312 4.25917 12.8 4.6873 12.2719 4.6873C11.7406 4.6873 11.3125 4.25605 11.3125 3.72792C11.3125 3.19667 11.7438 2.76855 12.2719 2.76855C12.8 2.76855 13.2312 3.19979 13.2312 3.72792Z"
                    fill="#EEF7FC"
                  />
                </svg>
              </Link>
              <Link href="#" aria-label="X/Twitter">
                ...
                >
                  <path
                    d="M12.6001 2.00781H14.8444L10.0409 7.58203L15.8001 15.2578H11.3151L7.86525 10.672L3.86835 15.2578H1.62246L6.76568 9.28984L1.2001 2.00781H5.80144L8.89328 6.17427L12.6001 2.00781ZM11.9548 13.8266H13.1114L5.10288 3.36721H3.85811L11.9548 13.8266Z"
                    fill="#EEF7FC"
                  />
                </svg>
              </Link>
        ...
        <div className="flex flex-col gap-8">
          ...
          {/* Footer Bottom */}
          <div className="flex flex-col items-center justify-between gap-4 pb-8 md:flex-row md:gap-16">
            <p className="text-sm font-medium text-[#dfe3e7]">
              © 2025 Alfred Investments LLC. All rights reserved.
            </p>

            <div className="flex gap-6">
              <Link href="#" className="text-sm font-medium text-[#dfe3e7]">
                Privacy Policy
              </Link>
              <Link href="#" className="text-sm font-medium text-[#dfe3e7]">
                Terms of Use
